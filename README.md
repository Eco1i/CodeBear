...
从 GitHub Releases 下载 `CodeBear-v1.0.0-win-x64.zip`。同名 `.sha256` 文件用于可选的完整性校验：

```powershell
Get-FileHash .\CodeBear-v1.0.0-win-x64.zip -Algorithm SHA256
Get-Content .\CodeBear-v1.0.0-win-x64.zip.sha256
```
